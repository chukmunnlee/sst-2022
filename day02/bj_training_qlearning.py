...
for e in tqdm(range(EPISODES)):
    ...
    while not done:
        ...
        if done:
            ...
            predicted_future_reward = q_max_value(new_state)
...
#plt.plot(lose_rate, label="lose rate")
#plt.title(f'wins: {win_rate[-1]}')
#plt.legend()
#plt.show()